...
class CarModel(models.Model):
    ...
    length_mm = models.IntegerField(null=True, blank=True, help_text='Overall length in mm')
    width_mm = models.IntegerField(null=True, blank=True, help_text='Overall width in mm')
    height_mm = models.IntegerField(null=True, blank=True, help_text='Overall height in mm')
